...
# Generated on: Fri Dec 29 12:53:33 IST 2023 (Fri Dec 29 07:23:33 UTC 2023)
...
set logfile fv/vedic8x8/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/vedic8x8 -revised fv_map
...
add_search_path /home/student/Desktop/G26_BD -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/G26_BD/BDcode.v
elaborate_design -golden -root {vedic8x8} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/vedic8x8/fv_map.v.gz
elaborate_design -revised -root {vedic8x8}
...
#add_name_alias fv/vedic8x8/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.vedic8x8.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.vedic8x8.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.vedic8x8.rtl.fv_map.rpt
